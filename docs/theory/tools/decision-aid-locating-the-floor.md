---
title: "Decision Aid — Locating the Floor"
subtitle: "Clinician decision aid (text procedure) for the unified clinical model"
type: clinical-tool
tags:
  - clinical-tool
  - decision-aid
...
> [!note] When to leave the aid
> If the problem is a bodily prior and you have only words, add a modality or refer — don't talk harder. If a biological loading is likely, refer for medication before expecting any prior to move. The aid organizes formulation and technique; it does not replace diagnosis, risk judgment, or the standard of care. See the boundaries in [[A Unified Clinical Model of Psychotherapy]] Part 7.
