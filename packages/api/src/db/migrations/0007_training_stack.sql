...
--
-- Numbering: 0004 is the assistant's gate-question column. 0005 and 0006 are
-- deliberately unused, held for prompts that are specified but not yet built.
-- Drizzle applies in journal order rather than filename order, so the gap is
-- cosmetic.
--
